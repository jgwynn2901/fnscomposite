 ...
 **************************************************************************/
/* $Header: /SourceCode/Components/FNS2005/FnsComposite/SegmentObjects/EmployeeSegment.cs 8     9/21/10 6:30p Gwynnj $ */
#endregion
...
{
	/// <summary>
	/// Summary description for EmployeeSegment.
	/// </summary>
	[ClassInterface(ClassInterfaceType.None), ComVisible(false)]
  public class EmployeeSegment : Segment, Interfaces.IEmployee
	{
		...
		/// </summary>
		public EmployeeSegment() :base("EMPLOYEE")
		{
			ColumnNames = new[]
			              	{
			              		"EMPLOYEE_ID",
		...
		public EmployeeSegment(Interfaces.IEmployee rec): this()
		{
			Ssn = rec.Ssn;
			AhsId = rec.AhsId;
...
#region Log
/*
 * $Log: /SourceCode/Components/FNS2005/FnsComposite/SegmentObjects/EmployeeSegment.cs $
 * 
 * 8     9/21/10 6:30p Gwynnj
 * Created EntityBase to factor the IPerson interface
 * 
 * 7     11/09/09 11:24a John.gwynn
 * missing comments added
 * 
 * 6     11/03/09 3:01p John.gwynn
 * fixed a bug in AhsPolicySegment.SetParentKey
 * 
 * 5     9/26/09 12:46p John.gwynn
 * Added IAccountHierarchyStep interface
 * 
 * 4     4/09/08 8:38a Jenny.cheung
 * added phone field to the segment
 * 
 * 3     11/07/07 9:13a Jenny.cheung
 * 
 * 2     9/24/07 5:35p John.gwynn
 * merged with 2003 changes
 * 
 * 1     7/10/07 5:37p John.gwynn
