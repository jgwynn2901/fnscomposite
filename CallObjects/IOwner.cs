...
**************************************************************************/
/* $Header: /SourceCode/Components/FNS2005/FnsComposite/CallObjects/IOwner.cs 2     5/01/08 4:13p John.gwynn $ */
#endregion
...
{
	/// <summary>
	/// CallObject interface for [Property/Vehicle] Owner
	/// </summary>
	public interface IOwner : IComposite, IPerson
	{
		/// <summary>
...
#region Log
/*
 * $Log: /SourceCode/Components/FNS2005/FnsComposite/CallObjects/IOwner.cs $
 * 
 * 2     5/01/08 4:13p John.gwynn
 * refactored IPerson interface and added support for Contact
 * 
 * 1     10/21/07 3:44p John.gwynn
