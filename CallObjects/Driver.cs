...
**************************************************************************/
/* $Header: /SourceCode/Components/FNS2005/FnsComposite/CallObjects/Driver.cs 4     9/21/10 6:29p Gwynnj $ */
#endregion
...
namespace FnsComposite.CallObjects
{
  ...
  public class Driver : EntityBase, IDriver
  {
    ...
    public Driver(XmlNode node) : base (node)
    {}
    ...
    public ICitation Citation
    {
      get
      {

        ICitation node = GetObject<Citation>("CITATION") as Citation;
        if (node == null)
        {
...
#region Log
/*
 * $Log: /SourceCode/Components/FNS2005/FnsComposite/CallObjects/Driver.cs $
 * 
