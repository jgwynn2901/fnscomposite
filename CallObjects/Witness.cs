...
**************************************************************************/
/* $Header: /SourceCode/Components/FNS2005/FnsComposite/CallObjects/Witness.cs 2     9/21/10 6:30p Gwynnj $ */
#endregion
...
namespace FnsComposite.CallObjects
{
	...
	/// 
	/// </summary>
	public class Witness : CallObjectBase, IWitness
	{
		private const string _nodeTypeName = "WITNESS";
		/// <summary>
		/// Initializes a new instance of the <see cref="Witness"/> class.
		/// </summary>
		public Witness(): base(_nodeTypeName)
		{}
		/// <summary>
		/// Initializes a new instance of the <see cref="Witness"/> class.
		/// </summary>
		/// <param name="node">The node.</param>
			public Witness(XmlNode node) : base (node)
		{}
			/// <summary>
			/// Initializes a new instance of the <see cref="Witness"/> class.
			/// </summary>
			...
			public Witness(XmlNode node, string indexedName) : base (node, indexedName)
		{}
			/// <summary>
			/// Initializes a new instance of the <see cref="Witness"/> class.
			/// </summary>
			/// <param name="indexName">Name of the index.</param>
		public Witness(string indexName)
...
#region Log
/*
 * $Log: /SourceCode/Components/FNS2005/FnsComposite/CallObjects/Witness.cs $
 * 
 * 2     9/21/10 6:30p Gwynnj
 * Created EntityBase to factor the IPerson interface
 * 
 * 1     2/18/08 8:31p John.gwynn
